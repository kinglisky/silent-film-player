...
MPEG1.prototype = Object.create(Base.prototype);
MPEG1.prototype.constructor = MPEG1;

MPEG1.prototype.write = function(pts, buffers) {
	Base.prototype.write.call(this, pts, buffers);
...
MPEG1.prototype.decode = function() {
	...
	var elapsedTime = uitls.Now() - startTime;
